...
class BSStoreCardTests: XCTestCase {
    ...
    func testStoreCardTrueVisa() {
        let cc: [String: String] = BluesnapSDKIntegrationTestsHelper.getVisa()
        guard let vaultedShopperId = BSIntegrationTestingAPIHelper.createVaultedShopper(creditCard: cc, storeCard: true) else {
            XCTFail("Failed to create vaulted shopper"); return
        }
    ...
    func testStoreCardFalseVisa() {
        let cc: [String: String] = BluesnapSDKIntegrationTestsHelper.getVisa()
        guard let vaultedShopperId = BSIntegrationTestingAPIHelper.createVaultedShopper(creditCard: cc, storeCard: false) else {
            XCTFail("Failed to create vaulted shopper"); return
        }
