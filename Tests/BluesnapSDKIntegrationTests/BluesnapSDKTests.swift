...
class BluesnapSDKTests: XCTestCase {
    ...
    func testValidNumbers() {
        let futureExp = BluesnapSDKIntegrationTestsHelper.futureExpDate()
        testSubmitCCDetailsSuccess(ccn: "4111 1111 1111 1111", cvv: "111", exp: futureExp)
        testSubmitCCDetailsSuccess(ccn: "5204 2452 5046 0049", cvv: "111", exp: futureExp)
    }
