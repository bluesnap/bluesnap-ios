...
class BluesnapSDKIntegrationTestsHelper {
    ...
    static func futureExpDate(month: Int = 10) -> String {
    ...
    static func getVisa() -> [String: String] {
        return ["ccn": "4111111111111111", "exp": futureExpDate(month: 10), "cvv": "111", "ccType": "VISA", "last4Digits": "1111", "issuingCountry": "US"]
    }

    static func getMasterCard() -> [String: String] {
        return ["ccn": "5555555555555557", "exp": futureExpDate(month: 11), "cvv": "123", "ccType": "MASTERCARD", "last4Digits": "5557", "issuingCountry": "BR"]
    }
